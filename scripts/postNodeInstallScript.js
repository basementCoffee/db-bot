...
replaceContents('./node_modules/ytdl-core/lib/sig.js', './scripts/textFileAssets/ytdlCoreSig.txt',
  (err) => {
    fileReplacementCallback(err, 'ytdl-core scripts');
  });

replaceContents('./node_modules/spotify-url-info/src/index.js', './scripts/textFileAssets/spotify-url-info-index.txt',
  (err) => {
    fileReplacementCallback(err, 'spotify-url-info scripts');
  });

replaceContents('./node_modules/ytsr/lib/parseItem.js', './scripts/textFileAssets/ytsr-parseItem.txt',
  (err) => {
