...
const { linkFormatter } = require('../utils/formatUtils');
 ...
 * @returns {*} 1 if passed
 */
function insertCommandVerification(message: Message, server: LocalServer, args: string[]): number {
